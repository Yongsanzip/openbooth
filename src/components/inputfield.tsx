...
function Inputfield(props){
  ...
  const _onChangeFile = () => {
    ...
    return (
        <InputField disabled={props.disabled} isFocus={isFocus} width={props.width} customStyle={props.style} type={props.type} >
...
const InputField = styled.div`
  ...
  border-radius: 8px;
  height: 40px;
  padding: ${(props: InputFieldProps) => (props.type != null && props.type == 'file'? '0' : '0 10px')};
  ...
  height: ${(props: InputFieldProps) => (props.type != null && props.type == 'file'? '104px' : '')};
