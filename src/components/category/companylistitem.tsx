...
interface CompanyListitemCompProps {
    isLarge: any
}
...
> div {
    ...
    &.titleImg {
        width: ${(props: CompanyListitemCompProps) => (props.isLarge ? '106px' : '80px')};
        height: ${(props: CompanyListitemCompProps) => (props.isLarge ? '104px' : '80px')};
        background: #DBDBDB;
    ...
    &.content {
        ...
        color: #999999;
        font-weight: normal;
        font-size: ${(props: CompanyListitemCompProps) => (props.isLarge ? '14px' : '12px')};
        line-height: 20px;
        color: #999999;
        margin-left: 16px;
        width: 272px;
        & > * {
            ...
            :first-child {
                font-weight: bold;
                font-size: ${(props: CompanyListitemCompProps) => (props.isLarge ? '16px' : '14px')};
                line-height: 22px;
                color: #000000;
                margin-bottom: ${(props: CompanyListitemCompProps) => (props.isLarge ? '8px' : '12px')};
            }
        }
    }
    &.into {
