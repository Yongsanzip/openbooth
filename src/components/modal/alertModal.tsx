...
interface AlertModalComp {
    type: string;
}
const AlertModalComp = styled.div`
    width: 100%;
    background: ${(props: AlertModalComp) => (props.type != null && props.type == 'dark'? '#212121': '#ffffff')};
    > div {
        font-weight: bold;
        font-size: 16px;
        line-height: 24px;
        ...
        :first-child {
            ...
            font-size: 18px;
            line-height: 26px;
            color: ${(props: AlertModalComp) => (props.type != null && props.type == 'dark'? '#E9E9E9': '#000000')};
        }
        :nth-child(2){
            min-height: 102px;
        }
        &.btns {
            text-align: right;
            border-top: 1px solid ${(props: AlertModalComp) => (props.type != null && props.type == 'dark'? '#333333': '#E9E9E9')};
            padding: 10px;
        }
    }
`;
